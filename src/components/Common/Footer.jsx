        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 mb-12 md:mb-20">
          <div className="space-y-4">
            ...
            <h2 className="text-5xl md:text-[8rem] font-black leading-[0.9] tracking-tighter uppercase">
              Let's build <br />
              <span className="text-zinc-800 italic hover:text-white transition-all duration-500">
                together.
              </span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 py-12 border-t border-zinc-900">
          <div className="space-y-4">
            <div className="flex flex-col">
              <span className="text-xl font-black tracking-tighter uppercase">
                CodeWebX<span className="text-[#00a63e]">.</span>
              </span>
              <span className="text-[7px] text-[#00a63e] font-bold tracking-[0.2em] uppercase">
                Technologies
              </span>
            </div>
            <p className="text-zinc-500 text-xs font-medium leading-relaxed max-w-xs">
              Engineering high-performance digital products for startups and
              global brands.
            </p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col gap-4 text-zinc-400 text-xs">
              ...
              <button
                ...
                className="hover:text-white flex items-center gap-3 transition-colors w-fit font-bold"
              >
          ...
          <div className="space-y-5">
            ...
            <ul className="grid grid-cols-2 gap-y-3 gap-x-6 text-zinc-400 text-[10px] font-bold tracking-widest uppercase">
              <li>
                <Link to="/" className="hover:text-[#00a63e] transition-colors">
                  Home
                </Link>
              </li>
              <li>
        ...
        {isPrivacyOpen && (
          <div className="fixed inset-0 z-[300] flex items-center justify-center p-5">
            ...
            <motion.div
              ...
              className="relative bg-[#0a0a0a] border border-white/10 w-full max-w-lg max-h-[70vh] overflow-hidden rounded-3xl flex flex-col shadow-2xl"
            >
              <div className="p-5 border-b border-white/5 flex justify-between items-center bg-zinc-900/30">
                <span className="text-xs font-black tracking-widest uppercase text-[#00a63e]">
                  Legal Policy
                </span>
                <button
                  onClick={() => setIsPrivacyOpen(false)}
              ...
              <div className="p-8 overflow-y-auto text-zinc-500 text-[11px] leading-relaxed space-y-4 text-left">
                <p>
                  <strong className="text-white">1. Data Collection:</strong> We
                  collect your name and email to answer your business inquiries
                  via our contact forms.
                </p>
                <p>
                  <strong className="text-white">2. Usage:</strong> Your
                  personal details are strictly used for communication and are
                  never shared or sold to third-party marketing agencies.
                </p>
                <p>
                  <strong className="text-white">3. Security:</strong> We
                  implement industry-standard security measures to protect your
                  project data and personal info.
                </p>
                <p className="pt-4 border-t border-white/5 text-zinc-800 uppercase text-[9px] font-black tracking-widest">
