  ...
  return (
    <section className="py-24 bg-white overflow-hidden relative text-left">
      <style dangerouslySetInnerHTML={{__html: `
        ...
        /* 🚀 DESKTOP WHEEL SCROLL FIX: Enforced strict scroll propagation chain */
        .modal-scroll-area {
      ...
      {/* BADA ANIMATED ARROW INDICATOR */}
      {projects.length > 1 && (
        <div className="w-full flex flex-col items-center justify-center mt-4 mb-2 select-none pointer-events-none">
          <div className="flex items-center justify-center gap-3 text-zinc-300 font-light text-4xl md:text-5xl tracking-[-0.15em]">
          ...
          <span className="text-[9px] font-black uppercase tracking-[0.4em] text-zinc-400 mt-1 block opacity-80">
            Swipe to explore creations
          </span>
        </div>
      )}
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 md:p-10">
            ...
            >
              ...
              {/* Left Side: Image */}
              <div className="md:w-1/2 w-full h-[30%] md:h-full shrink-0 bg-zinc-50">
              ...
              {/* 🚀 FIXED RIGHT CONTAINER: Changed h-full overflow-hidden to h-auto max-h-full to properly bubble scroll events */}
