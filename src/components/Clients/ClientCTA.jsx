...
const ClientCTA = () => {
  ...
  return (
    <section className="px-6 md:px-16 py-10 md:py-16 bg-black">
      ...
      >
        {/* Background Decorative Circles - Compact Blur */}
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          {/* Left Side: Content - Tightened Spacing */}
          <div className="max-w-2xl text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
              <Stars className="text-white" size={18} />
              <span className="text-[9px] font-black uppercase tracking-[0.4em] text-white/80">Collaborate</span>
            </div>
            ...
            <p className="text-white/90 text-sm md:text-lg font-medium max-w-sm leading-snug">
              Join the elite group of businesses that chose <span className="text-white">CodeWebX</span> for digital transformation.
            </p>
          </div>

          {/* Right Side: Action Button - Refined Scale */}
          <div className="flex flex-col items-center gap-4">
            ...
            >
              <span className="text-[10px] font-black uppercase tracking-widest">Start Partnership</span>
            ...
            <span className="text-[8px] font-black text-white/40 uppercase tracking-[0.5em]">Global scale solutions</span>
          </div>
        </div>
      </div>
      ...
      {/* Subtle Footer Link - Navigating back to Portfolio */}
      <div className="max-w-[1400px] mx-auto mt-8 flex justify-center md:justify-end">
        <Link to="/works" className="group flex items-center gap-3 text-zinc-600 hover:text-white transition-colors">
            <span className="text-[9px] font-bold uppercase tracking-widest">Explore our tech portfolio</span>
